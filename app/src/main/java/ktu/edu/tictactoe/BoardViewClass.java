...
public class BoardViewClass extends View {
    ...
    private Paint gridPaint, oPaint, xPaint, linesPaint;
    private GameEngineClass gameEngine;
    private PlayGame activity;

    public BoardViewClass(Context context) {
        super(context);
    }

    public BoardViewClass(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        gridPaint = new Paint();
        gridPaint.setColor(getResources().getColor(R.color.colorBackground));
    ...
    public void setMainActivity(PlayGame a) {
        activity = a;
    }

    public void setGameEngine(GameEngineClass g) {
        gameEngine = g;
    }
    ...
    private void drawGrid(Canvas canvas) {
        for (int i = 0; i < 2; i++) {
            ...
            canvas.drawRect(left2, top2, right2, bottom2, linesPaint);
        }
    }
